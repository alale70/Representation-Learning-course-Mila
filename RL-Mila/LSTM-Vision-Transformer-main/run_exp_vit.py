...
def train(epoch, model, dataloader, optimizer, args):
    ...
    for idx, batch in enumerate(
        ...
        imgs, labels = batch
        logits = model(imgs)
        GPU.append(torch.cuda.memory_allocated(0)/1024/1024/1024)
    ...
    return epoch_loss, epoch_accuracy, time.time() - start_time, np.mean(np.asarray(GPU))
...
def main(args):
    ...
    for epoch in range(10):
        ...
        loss, acc, wall_time, GPU = train(epoch, model, train_dataloader, optimizer,args)
